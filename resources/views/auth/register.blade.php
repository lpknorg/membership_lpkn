...
<body>
  <div class="auth">
    ...
    <div class="auth__body">
        <form method="POST" action="{{ route('api.daftar_member') }}" class="auth__form" autocomplete="off">
            @csrf
        <div class="auth__form_body">
          <h3 class="auth__form_title">Register</h3>
          <div>
            <div class="form-group">
              <label class="text-uppercase small">Nama Lengkap</label>
              <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" name="nama_lengkap">
            </div>
            <div class="form-group">
              <label class="text-uppercase small">No Hp</label>
            ...
            <div class="form-group">
              ...
              <input id="email" type="email" class="form-control" placeholder="Masukkan email" name="email">
            </div>
            <div class="form-group">
        ...
        <div class="auth__form_actions">
          ...
          <div class="mt-2">
            <a href="{{route('login')}}" class="small text-uppercase">
              LOGIN
            </a>
          </div>
        </div>
